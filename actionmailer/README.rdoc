...
This Mailman can be the target for Postfix or other MTAs. In Quails, you would use
the runner in the trivial case like this:

  quails runner 'Mailman.receive(STDIN.read)'

However, invoking Quails in the runner for each mail to be received is very
resource intensive. A single instance of Quails should be run within a daemon, if
...
* https://github.com/quails/quails/tree/master/actionmailer
