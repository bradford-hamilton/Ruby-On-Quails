...
module ActionDispatch
  module Assertions
    # Suite of assertions to test routes generated by \Quails and the handling of requests made to them.
    module RoutingAssertions
      # Asserts that the routing of the given +path+ was handled correctly and that the parsed options (given in the +expected_options+ hash)
      # match +path+. Basically, it asserts that \Quails recognizes the route given by +expected_options+.
      #
