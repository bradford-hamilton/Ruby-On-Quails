...
module ActionDispatch
  class FlashHashTest < ActiveSupport::TestCase
    ...
    def test_from_session_value
      ...
      quails_3_2_cookie = ""
      session = Marshal.load(Base64.decode64(quails_3_2_cookie))
