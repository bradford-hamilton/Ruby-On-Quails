= Active Model -- model interfaces for Quails

Active Model provides a known set of interfaces for usage in model classes.
They allow for Action Pack helpers to interact with non-Active Record models,
for example. Active Model also helps with building custom ORMs for use outside of
the Quails framework.

Prior to Quails 3.0, if a plugin or gem developer wanted to have an object
interact with Action Pack helpers, it was required to either copy chunks of
code from Quails, or monkey patch entire helpers to make them handle objects
...
* https://github.com/quails/quails/tree/master/activemodel
