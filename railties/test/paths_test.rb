  ...
  test "A failed symlink is still a valid file" do
    Dir.mktmpdir do |dir|
      Dir.chdir(dir) do
        ...
        root = Quails::Paths::Root.new("foo")
        root.add "bar.rb"
